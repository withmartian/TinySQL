...
def get_errors(max_seq_length=512, cs_num=3, model_num=1, syn=True, batch_size=32, percentage="100"):
    ...
    dataset = load_dataset(dataset_name)[dataset_type][f":{percentage}%"]
