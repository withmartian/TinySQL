...
def generate_cs3(batch_size, order_by_clause_probability=0.9, min_cols=2, max_cols=12, use_synonyms_table=False, use_synonyms_field=False):
  return generate_cs2(batch_size, order_by_clause_probability, use_aggregates=True, min_cols=min_cols, max_cols=max_cols, use_synonyms_table=use_synonyms_table, use_synonyms_field=use_synonyms_field)
