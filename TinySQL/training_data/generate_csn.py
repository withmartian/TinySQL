...
def generate_csn(batch_size:int, csn:int, order_by_clause_probability:float=0.9, use_aggregates:bool=False, min_cols:int=2, max_cols:int=12, use_synonyms_table:bool=False, use_synonyms_field:bool=False):
    if csn == 1:
