...
class TestAblateBM1(unittest.TestCase):
    ...
    def test_ablate_bm1_head(self):
        ablate_bm1(self.tokenizer, self.model, node_type="head", layer_index=0, head_index=5)
        ablate_bm1(self.tokenizer, self.model, node_type="head", layer_index=1, head_index=4)
