...
class TestAblate_BM1(TestAblate):
    ...
    def setUp(self):
        tokenizer, model = load_sql_interp_model(1, 0, use_flash_attention=False, device_map="cpu")
...
class TestAblate_BM1_CS1(TestAblate):
    ...
    def setUp(self):
        tokenizer, model = load_sql_interp_model(1, 1, use_flash_attention=False, device_map="cpu")
...
class TestAblate_BM1_CS2(TestAblate):
    ...
    def setUp(self):
        tokenizer, model = load_sql_interp_model(1, 2, use_flash_attention=False, device_map="cpu")
...
class TestAblate_BM1_CS3(TestAblate):
    ...
    def setUp(self):
        tokenizer, model = load_sql_interp_model(1, 3, use_flash_attention=False, device_map="cpu")
